            ...
            touch: function() {
                ...
                function g() {
                    ...
                    if (a.animatingTo === a.currentSlide && !p && null !== j) { var h = m ? -j : j,
                        ...
                        a.canAdvance(l) && (550 > Number(new Date) - k && 50 < Math.abs(h) || Math.abs(h) > q / 2) ? a.flexAnimate(l, c.pauseOnAction) : r || a.flexAnimate(a.currentSlide, c.pauseOnAction, !0) } i.removeEventListener("touchend", g, !1);
                    f = j = e = d = null
                }
                var d, e, f, q, j, k, p = !1;
